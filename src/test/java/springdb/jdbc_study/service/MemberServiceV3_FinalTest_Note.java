...
/*
 SpringBoot 는
 DataSource 와 - DataSource 는 application.properties 를 통해서
 TxManager 를 자동으로 주입해준다 - PlatformTransactionManager
 TxManager 구현체 - 적용중인 Library 를 보고 알아서 TxManager 구현체를 주입해줌
 */
@SpringBootTest
@Slf4j
public class MemberServiceV3_FinalTest_Note {
